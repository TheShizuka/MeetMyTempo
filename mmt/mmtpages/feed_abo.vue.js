var Feed_abo = Vue.component('Feed_abo',{
   ...
   <div id="header">
       ...
       :to="{name : 'Feed_general'}"><button class="boutonHeader">Géneral</button></router-link>
       <router-link class="nav-link"
       :to="{name : 'Feed_abo'}"><button class="boutonHeader activ">Abonnements</button></router-link>
       </div>
   </div>
