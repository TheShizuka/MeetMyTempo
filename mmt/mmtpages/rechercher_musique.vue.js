var Rechercher_musique = Vue.component('Rechercher_musique',{
    ...
    <div id="header">
        ...
        <a href="Accueil.html"><button class="boutonRechercher"><img src="img/fleche.png" height="56" width="56"/></button></a>
          ...
          :to="{name : 'Rechercher_musique'}"><button class="boutonFooter activ"><img src="img/play.png" height="50" width="50"/></button></router-link>
          <router-link class="nav-link"
