var Rechercher_personne = Vue.component('Rechercher_personne',{
    ...
    <div id="header">
        ...
        <a href="Accueil.html"><button class="boutonRechercher"><img src="img/fleche.png" height="56" width="56"/></button></a>
          ...
          <router-link class="nav-link"
          :to="{name : 'Rechercher_groupe'}"><button class="boutonFooter "><img src="img/profil.png" height="50" width="50"/></button></router-link>
          <router-link class="nav-link"
          :to="{name : 'Rechercher_personne'}"><button class="boutonFooter activ"><img src="img/profil.png" height="50" width="50"/><img src="img/profil.png" height="50" width="50"/></button></router-link>
          </div>
    </div>
